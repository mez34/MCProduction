...
config.General.requestName = 'MonoHgg_2HDM_MZP2500_MA0300_13TeV_step1'
config.General.workArea = 'crab_projects'

config.JobType.pluginName = 'PrivateMC'
config.JobType.generator = 'lhe'
config.JobType.psetName = 'step1.py'
config.JobType.inputFiles = ['LHEFiles/2HDM/MZP2500_MA0300.lhe']
...
config.Data.primaryDataset = 'MonoHgg_2HDM_MZP2500_MA0300_13TeV'
...
config.Data.publishDataName = 'MonoHgg_2HDM_MZP2500_MA0300_Hgg_step1'
